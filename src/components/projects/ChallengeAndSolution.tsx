  ...
  return (
    <FadeIn
      className={classNames(
        "flex lg:flex-row flex-col items-center gap-y-5 lg:gap-x-[80px]",
    ...
    >
      <div className={classNames(imageUrl && "mt-[50px] lg:mt-[100px]")}>
        <div className="mb-[15px] text-lg text-primary lg:mb-[30px] lg:text-2xl">
          {isChallenge ? t("MAIN CHALLENGE") : t("OUR SOLUTION")}
        </div>
...
export const ChallengeAndSolution: FC<ChallengeAndSolutionProps> = ({
  ...
  return (
    <div className="container mt-[40px] flex flex-col gap-y-[100px] pb-[80px] lg:mt-[80px] lg:gap-y-[200px] lg:pb-[165px]">
