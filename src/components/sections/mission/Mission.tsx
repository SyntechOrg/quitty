...
const Mission = () => {
  ...
  return (
    <div
      className="mt-20 flex flex-col items-start justify-center gap-14 pb-[60px] pt-[15px] max-lg:mx-auto
       max-lg:max-w-[600px] lg:mt-32 lg:flex-row lg:justify-between lg:gap-[0] lg:pb-[100px] lg:pt-[40px]"
    >
