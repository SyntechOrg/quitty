  ...
  return (
    ...
    >
      ...
      <div className="w-full max-lg:mx-auto lg:w-1/2">
        ...
        <div className="group mt-[20px] flex w-fit items-center max-lg:mx-auto max-lg:justify-center md:mt-[24px] lg:mt-[32px]">
          <Button to={`/${localActive}/about`}>{t("AboutUs button-1")}</Button>
          <Button to={`/${localActive}/about`} className="btn2 px-[21px]">
