    ...
    <FadeIn>
      ...
      >
        <div className="relative w-full max-lg:w-full lg:flex lg:justify-between lg:gap-6">
          <div className="sticky top-[100px] flex h-[47vh] w-full items-center overflow-hidden lg:top-[45px] lg:h-screen lg:w-1/2">
            <PromoLeft scrollYProgress={scrollYProgress} />
          </div>
          <div className="sticky top-[calc(47vh+110px)] flex h-[calc(53vh-110px)] w-full items-center overflow-hidden lg:top-[45px] lg:h-screen lg:w-1/2">
